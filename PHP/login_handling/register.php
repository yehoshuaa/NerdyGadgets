        ...
        <div class="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="loginhandler.php" method="POST">
                    ...
                    <button type="submit" class="w-full text-white bg-[#4666ff] hover:bg-[#4666ff] focus:ring-4 focus:outline-none focus:ring-[#4666ff] font-medium rounded-lg text-sm px-5 py-2.5 text-center">Registreer</button>
